...
const Data = () => {
  return (
      <div className='home__data'>
            <h1 className='home__title'>Lakshmi Priya S K
          ...
          <p className='home__description'>I'm a Frontend Developer with a passion for intelligent interfaces and data-driven design. Currently pursuing an B.Tech Computer Engineering at VIT Chennai, I specialize in building responsive UIs, ML-powered systems, and real-time automation workflows.
